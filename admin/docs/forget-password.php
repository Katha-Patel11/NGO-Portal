  ...
  if(isset($_POST['submit']))
  {
    ...
    if($count>0)
    {
        ...
        try {
            ...
            $mail->Body    = "Hi!! Your Password is {$row['admin_password']} ";
            $mail->AltBody = "Hi!! Your Password is {$row['admin_password']} ";
      ...
      <div class="login-box col-md-4">
        <form class="login-form " method="post">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="email" placeholder="Email" autofocus name="admin_email" required>
          </div>
