...
if (isset($_POST['submit3'])) {
  ...
  $sql = "insert into tbl_order_master (user_id,order_date) values('$uid','$order_date')";
...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i>Order Master Form</h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">Forms</li>
      <li class="breadcrumb-item"><a href="#">Order Master Form</a></li>
    </ul>
  </div>
  <div class="col-md-6" style="text-align:left;">
    <div class="tile">
      <h3 class="tile-title">Order Master </h3>
      <div class="tile-body">
      ...
      <div class="tile-footer">
        <div class="row">
          <div class="col-md-8 col-md-offset-3">
            <input type="submit" value="Submit" name="submit3" class="btn btn-primary">&nbsp;&nbsp;&nbsp;<input
