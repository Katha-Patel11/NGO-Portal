...
<!-- Sidebar menu-->
    ...
    <?php
      ...
      if(isset($_POST['submit7']))
      {
          ...
          $sql="insert into tbl_feedback (feedback_date,feedback_details,user_id) values('$date','$detail','$userid')";
          if(mysqli_query($conn,$sql))
          {
            echo "<script>window.location='feedback-table.php';</script>";
          }
          else
          {
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <div class="col-md-6" style="text-align:left;">
          <div class="tile">
            <h3 class="tile-title">Feedback Details</h3>
            <div class="tile-body">
              <form class="form-horizontal" method="post">
                <div class="form-group row">
                  <label class="control-label col-md-3">Feedback Date</label>
                  <div class="col-md-8">
                    <input class="form-control" type="date" placeholder="Enter feedback date" name="feedback_date" required>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <textarea class="form-control" placeholder="Details" rows="5" cols="40" name="feedback_details"></textarea>
                  </div>
                </div>
