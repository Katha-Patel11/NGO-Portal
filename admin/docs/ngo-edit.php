...
if ($_POST) {
  ...
  $sql = "update tbl_ngo_master set ngo_name='$name', ngo_reg_no='$reg_no', ngo_details='$details', ngo_address='$address',sector_id='$sid',area_id='$aid',city_id='$cid',ngo_mobile_no='$mo_no', ngo_email='$email', ngo_found_year='$found_year', ngo_image='$image', is_valid='$is_valid' where ngo_id='$id'";
  $result = mysqli_query($conn, $sql);
  if ($result) {
    move_uploaded_file($path, "ngo-uploads/" . $image);
    echo "<script>alert('Record Updated Successfully');window.location = 'ngo-table.php';</script>";
  }
}
      ...
      <div class="tile-body">
        <form class="form-horizontal" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input class="form-control" type="number" placeholder="Is Valid" name="is_valid"
                value="<?php echo $isvalid; ?>" required>
            </div>
          </div>
          <!--<div class="form-group row">
