...
<!-- Sidebar menu-->
    ...
    <?php
      ...
      if(isset($_POST['submit6']))
      {
          ...
          $sql="insert into tbl_donation (ngo_id,donation_amount,user_id) values('$ngo_id','$amount','$user_id')";
          if(mysqli_query($conn,$sql))
          {
            echo "<script>window.location='donation-table.php';</script>";
          }
          else
          {
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <div class="col-md-6" style="text-align:left;">
          <div class="tile">
            <h3 class="tile-title">Donation Details</h3>
            <div class="tile-body">
              ...
              <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" placeholder="Enter amount" name="donation_amount" required>
                  </div>
                </div>
