    ...
    <?php
      ...
      if(isset($_POST['submit10']))
      {
          ...
          $gender=$_POST['volunteer_gender'];
              $sql="insert into tbl_volunteer (volunteer_name,volunteer_email,volunteer_address,volunteer_mobile_no,volunteer_dob,volunteer_gender) values('$name','$email','$address','$mo_no','$dob','$gender')";
              if(mysqli_query($conn,$sql))
              {
                echo "<script>window.location='volunteer-table.php';</script>";
              }
              else
              {
                echo "Not Registered";
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <div class="col-md-6" style="text-align:left;">
          <div class="tile">
            <h3 class="tile-title">Volunteer Details</h3>
            <div class="tile-body">
              <form class="form-horizontal" method="post">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="email" placeholder="Enter email address" name="volunteer_email" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Address</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" placeholder="Enter your address" name="volunteer_address">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Contact Number</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" placeholder="Enter your contact no" name="volunteer_mobile_no">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">Date Of Birth</label>
                  <div class="col-md-8">
                    <input class="form-control" type="date" placeholder="Enter your dob" name="volunteer_dob">
                  </div>
                </div>
                <div class="form-group row" >
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="form-check">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="volunteer_gender" value="Other">Other
                      </label>
                    </div>
                  </div>
                </div>
