...
<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $q="select admin_password from tbl_admin where admin_id='$admin_id'";
    $result=mysqli_query($conn,$q);
    $row=mysqli_fetch_array($result);
    if($opass==$row['admin_password'])
    {
      if($npass==$cpass)
      {
        if($opass==$npass)
        ...
        {
          $sql="update tbl_admin set admin_password='$npass' where admin_id='$admin_id'";
