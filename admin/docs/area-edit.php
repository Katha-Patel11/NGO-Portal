...
<?php
    if($_POST)
    {
        ...
        $cid=$_POST['city_id'];
        $sql="update tbl_area set area_name='$name',city_id='$cid' where area_id='$id'";
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <div class="form-group row">
                  <label class="control-label col-md-3">Area Id</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" placeholder="Enter full name" name="area_id" value="<?php echo $aid; ?>" readonly> 
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" placeholder="Enter full name" name="area_name" value="<?php echo $aname; ?>" required>
                  </div>
                </div>
