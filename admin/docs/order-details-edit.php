...
<!-- Sidebar menu-->
    <?php
      ...
      $id=$_GET['bid'];
      $sql="select * from tbl_order_details where order_details_id='$id'";
...
<?php
  if(isset($_POST['submit']))
  {
    ...
    $qty=$_POST['qty'];
    $price=$_POST['price'];
    $sql="update tbl_order_details set order_id='$ooid', item_id= '$iid',qty ='$qty',price='$price' where order_details_id='$id'";
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <div class="form-group row">
                  <label class="control-label col-md-3">Order Details ID</label>
                  <div class="col-md-8">
                    <input class="form-control" type="text" name="order_details_id" value="<?php echo $oid?>" readonly>
                  </div>
                </div>
              <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="number" placeholder="Enter Price" name="price" value="<?php echo $price?>" required>
                  </div>
                </div>
            </div>
