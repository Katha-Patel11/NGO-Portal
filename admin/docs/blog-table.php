...
?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Blog Tables</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Tables</li>
          <li class="breadcrumb-item active"><a href="blog-table.php">Blog Tables</a></li>
        </ul>
      </div>
        <div class="col-md-12">
          <div class="tile">
              ...
              <tbody>
                <?php
                  ...
                  while($row=mysqli_fetch_array($r))
                  {
                    ...
                    echo "<td><a href='blog-edit.php?bid={$row['blog_id']}'>Edit</a> | <a href='?did={$row['blog_id']}'>Delete</a> </td>";
                    echo "</tr>";
                  }
                ?>
              </tbody>
