...
if (isset($_POST['search'])) {
    ...
    if (isset($_POST['sector_id']) && $_POST['sector_id'] != '') {
        if (isset($_POST['area_id']) && $_POST['area_id'] != '' || isset($_POST['city_id']) && $_POST['city_id'] != '') {
            $ngoq .= " AND";
        }
        $ngoq .= "`tbl_ngo_master`.`sector_id`='$sector_id' ";
    }
    if (isset($_POST['ngo_name']) && $_POST['ngo_name'] != '') {
        if (isset($_POST['city_id']) && $_POST['city_id'] != '' || isset($_POST['area_id']) && $_POST['area_id'] != '' || isset($_POST['sector_id']) && $_POST['sector_id'] != '') {
            $ngoq .= " AND";
        }
        $ngoq .= "`tbl_ngo_master`.`ngo_name` LIKE '%$ngo_name%' ";
    }
    // $ngoq .= " WHERE `tbl_ngo_master`.`city_id`='$cityid' AND `tbl_ngo_master`.`area_id`='$area_id' AND `tbl_ngo_master`.`sector_id`='$sector_id' AND `tbl_ngo_master`.`ngo_name` LIKE '%$ngo_name%'";

    $ngoq .= " ORDER BY `tbl_ngo_master`.`ngo_id` ASC;";
    $ngoq = str_replace("AND AND", "AND ",$ngoq);
    // echo $ngoq;
    // exit();
...
<div class="contact-search-area padding-bottom-100 padding-top-100">
    <div class="container">
        <div class="row">
            <div class="col-xl-5 col-lg-6"><br><br><br>
                <div class="content-area-wrapper bg-image" style="background-image: url('assets/img/search.jpg');">
                </div>
            </div>
            ...
            <div class="contact-form style-01">
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            <label class="control-label "><b>Sector</b></label>
                            <select class="form-control" style="height:50px; width:530px;" name="sector_id">
                        ...
                        <div class="form-group col-md-12">
                            <label class="control-label"><b>NGO Name</b></label>
                            <input class="form-control" style="height:50px; width:530px;"type="text" placeholder="Enter full name" name="ngo_name">
                        </div>
                        <div class="form-group col-md-12">
