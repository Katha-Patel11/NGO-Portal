...
?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Requirement Table</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Tables</li>
          <li class="breadcrumb-item active"><a href="#">Requirement Table</a></li>
        </ul>
      </div>
        <div class="col-md-12">
          <div class="tile">
              ...
              <tbody>
                <?php
                  ...
                  while($row=mysqli_fetch_array($r))
                  {
                    ...
                    echo "<td><a href='req-edit.php?rid={$row['req_id']}'>Edit</a> | <a href='?did={$row['req_id']}'>Delete</a> </td>";
                    echo "</tr>";
                    $i++;
                  }
                ?>
