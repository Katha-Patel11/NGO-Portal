        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner">
                    ...
                    <h2 class="page-title">Your Order Details</h2>
                    <ul class="page-list">
                        <li><a href="index.php">Home</a></li>
                        <li><span style="color:#fcb11a;">Your Order Details</span></li>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="card-body p-4">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    $iq = "SELECT * FROM `tbl_order_details` INNER JOIN `tbl_item` ON (`tbl_order_details`.`item_id` = `tbl_item`.`item_id`) WHERE `tbl_order_details`.`order_id`='{$_GET['order_id']}'";
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                                        <div>
                                                            <p class="mb-1" style="font-size:30px;">Order Items</p>
                                                            <p class="mb-0">You have <?php echo $numi; ?> items in your order</p>
                                                        </div>
                                                    </div>
                                                    <?php
                                                    ...
                                                    <div class="d-flex flex-row align-items-center">
                                                        ...
                                                        <?php
                                                        $userid = $_SESSION['user_id'];
                                                        $stq = "SELECT * FROM `tbl_order_details` INNER JOIN `tbl_item` ON (`tbl_order_details`.`item_id` = `tbl_item`.`item_id`) WHERE `tbl_order_details`.`order_id`='{$_GET['order_id']}'";
                                                    ...
                                                    <?php
                                                        ...
                                                        {
                                                            echo "<h3>Your Order Details is Empty</h3>";
                                                        }
                                                    ?>
                                                </div>
                                            </div>
